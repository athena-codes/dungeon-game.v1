...
const handleFourthQuestion = (name) => {
    rl.question(`𝙰𝚏𝚝𝚎𝚛 𝚖𝚊𝚔𝚒𝚗𝚐 𝚢𝚘𝚞𝚛 𝚠𝚊𝚢 𝚝𝚘 𝚝𝚑𝚎 𝚋𝚘𝚝𝚝𝚘𝚖 𝚘𝚏 𝚝𝚑𝚎 𝚜𝚝𝚊𝚒𝚛𝚌𝚊𝚜𝚎, 𝚢𝚘𝚞 𝚌𝚘𝚖𝚎 𝚝𝚘 𝚊 𝚍𝚎𝚊𝚍𝚜𝚝𝚘𝚙.
                 𝚈𝚘𝚞𝚛 𝚌𝚑𝚘𝚒𝚌𝚎𝚜 𝚊𝚛𝚎 𝚝𝚘 𝚎𝚒𝚝𝚑𝚎𝚛 𝚝𝚞𝚛𝚗 𝚛𝚒𝚐𝚑𝚝 𝚘𝚛 𝚕𝚎𝚏𝚝.
        ...
        if (input === controls[1]) {
            rl.question(`
              𝚃𝚑𝚎𝚛𝚎 𝚒𝚜 𝚊 𝚕𝚘𝚗𝚐 𝚑𝚊𝚕𝚕𝚠𝚊𝚢, 𝚜𝚘 𝚍𝚊𝚛𝚔 𝚝𝚑𝚎𝚛𝚎 𝚒𝚜 𝚗𝚘 𝚎𝚗𝚍 𝚒𝚗 𝚜𝚒𝚐𝚑𝚝.
                         𝚈𝚘𝚞 𝚙𝚛𝚘𝚌𝚎𝚎𝚍 𝚍𝚘𝚠𝚗 𝚒𝚝, 𝚞𝚗𝚜𝚞𝚛𝚎 𝚘𝚏 𝚠𝚑𝚊𝚝 𝚝𝚘 𝚎𝚡𝚙𝚎𝚌𝚝. → `, handleSeventhQuestion)
        }
        else if (input !== controls[0] || controls[1]) {
            rl.question(`𝙿𝚕𝚎𝚊𝚜𝚎 𝚎𝚗𝚝𝚎𝚛 𝚊 𝚟𝚊𝚕𝚒𝚍 𝚌𝚘𝚖𝚖𝚊𝚗𝚍, 𝚎𝚒𝚝𝚑𝚎𝚛 r 𝚘𝚛 l →
`, handleThirdQuestion)
...
const handleSixthQuestion = (input) => { rl.question(`
...
const handleSeventhQuestion = (input) => {
 rl.question(`
      𝚈𝚘𝚞 𝚏𝚒𝚗𝚊𝚕𝚕𝚢 𝚊𝚙𝚙𝚛𝚘𝚊𝚌𝚑 𝚊 𝚍𝚘𝚘𝚛. 𝚈𝚘𝚞 𝚘𝚙𝚎𝚗 𝚝𝚑𝚎 𝚑𝚊𝚗𝚍𝚕𝚎 𝚊𝚗𝚍 𝚜𝚎𝚎 𝚠𝚑𝚊𝚝𝚜 𝚘𝚗 𝚝𝚑𝚎 𝚘𝚝𝚑𝚎𝚛 𝚜𝚒𝚍𝚎...
             ...
             ||| || |||
             |||_||_|||
             ||______||  →`, handleSixthQuestion)
}

const handleEigthQuestion = (name) => {
...
const handleTenthQuestion = (name) => {
    rl.question(`
...
|       |  /'
         |                           |﹋|
                                    (҂^o^)
                                    <,︻╦╤─ ҉ - - -
                                      |﹋|             𝙱𝚒𝚕𝚕 𝚏𝚒𝚛𝚎𝚜 𝚝𝚑𝚛𝚎𝚎 𝚛𝚘𝚞𝚗𝚍𝚜 𝚘𝚏𝚏 𝚑𝚒𝚜 𝚐𝚞𝚗, 𝚜𝚕𝚊𝚒𝚗𝚒𝚗𝚐 𝚝𝚑𝚎 𝚖𝚘𝚗𝚜𝚝𝚎𝚛 →
